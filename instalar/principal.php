      ...
      <div class="card card-block">
        ...
        <form method="post">
          <div class="form-group row">
            ...
            <div class="col-md-9">
              <input type="text" class="form-control" name="servidor" value="localhost"></input>
            </div>
          </div>
          <div class="form-group row">
            <label for="usuario" class="col-md-3 col-form-label"><strong>Usuario</strong></label>
            <div class="col-md-9">
              <input class="form-control" type="text" name="usuario" value="root"></input>
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9">
              <input class="form-control" type="text" name="basedatos" value="gymdatos"></input>
            </div>
          </div>
...
function creaBD() {
  ...
  require_once 'instalar/config.php';
  ...
  $sql = $creabd . file_get_contents("instalar/mibd.sql");
